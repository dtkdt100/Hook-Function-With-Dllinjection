...
DllInjector::DllInjector(const Handle& pHandle)
{
	const char evilDLL[] = "C:\\Users\\dolev\\source\\repos\\DllInjection\\x64\\Debug\\DllFile.dll";
	...
	if (hKernel32 != 0) {
		...
		if (loc) WriteProcessMemory(pHandle.getRawHandle(), loc, evilDLL, evilLen, NULL);
